...
/**
 * Compatibility layer for Bukkit sounds
 *
 * Originally written by dblosevn adapted
 * for use with Server compatibility layer
 * by Spyda6
 */
public enum Sound {
    ...
    FIRE_IGNITE("BLOCK_FIRE_EXTINGUISH"),
    FIZZ("ENTITY_FIREWORK_BLAST"),
    FUSE("ENTITY_FIREWORK_LAUNCH"),
    ...
    NOTE_BASS_GUITAR("BLOCK_NOTE_BASEDRUM"),
    NOTE_SNARE_DRUM("BLOCK_NOTE_HAT"),
    ...
    GHAST_SCREAM("ENTITY_GHAST_WARN"),
    GHAST_SCREAM2("ENTITY_GHAST_SCREAM"),
    GHAST_CHARGE("ENTITY_GHAST_SHOOT"),
    ...
    MAGMACUBE_WALK2("ENTITY_MAGMACUBE_SQUISH"),
    ...
    SLIME_WALK2("ENTITY_SLIME_SQUISH"),
    ...
    ZOMBIE_UNFECT("ENTITY_ZOMBIE_VILLAGER_CURE"),
    ZOMBIE_REMEDY("ENTITY_ZOMBIE_VILLAGER_CONVERTED"),
    ...
    SUCCESSFUL_HIT("ENTITY_GENERIC_HURT"),
    ...
    HORSE_ZOMBIE_DEATH("ENTITY_ZOMBIE_HURT"),
    ...
    private final String enum19;

    Sound(String string19) {
        enum19 = string19;
    }

    public org.bukkit.Sound getValue() {
        Server.CraftbukkitVersion mVer = Server.getCraftbukkitVersion();

        if (Server.getVersionDouble(Server.getCraftbukkitVersion()) >=
            Server.getVersionDouble(Server.CraftbukkitVersion.v1_9_R1)) {

            return org.bukkit.Sound.valueOf(enum19);
        }
